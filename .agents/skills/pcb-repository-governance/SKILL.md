...
- fragile command or protocol mechanics: a helper beside its skill;
...
7. Verify publication by fetching or reading the remote-tracking ref and comparing its commit ID with the intended local integration commit. Report the concrete commit, remote URL, branch, and whether any recovery branch remains.
