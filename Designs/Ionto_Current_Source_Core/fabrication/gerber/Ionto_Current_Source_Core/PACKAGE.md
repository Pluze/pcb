...
Source: `Ionto_Current_Source_Core.kicad_pcb`.
Native Gerber X2, absolute millimetre coordinates, with matching Gerber job and Excellon drill data.

## Layer mapping

- `Ionto_Current_Source_Core-F_Cu.gbr`: F.Cu.
- `Ionto_Current_Source_Core-B_Cu.gbr`: B.Cu.
- `Ionto_Current_Source_Core-F_Mask.gbr`: F.Mask.
- `Ionto_Current_Source_Core-B_Mask.gbr`: B.Mask.
- `Ionto_Current_Source_Core-F_Silkscreen.gbr`: F.Silkscreen.
- `Ionto_Current_Source_Core-B_Silkscreen.gbr`: B.Silkscreen.
- `Ionto_Current_Source_Core-F_Paste.gbr`: F.Paste.
- `Ionto_Current_Source_Core-B_Paste.gbr`: B.Paste.
- `Ionto_Current_Source_Core-Edge_Cuts.gbr`: Edge.Cuts.
