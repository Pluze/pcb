...
- PCB-driven U4 audit passes for all five packages. Single boards contain top copper, bottom copper, one outline, and one plated-design drill; the panel additionally contains 17 `CutInside` contours.
- PCB-driven LightBurn audit passes for all 10 DXFs. `ezdxf` reports 0 errors and 0 fixes, and rendered front/back geometry matches the board sources.
